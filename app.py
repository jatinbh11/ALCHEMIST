...
icon_path = "hospital.png"  # Replace with the actual path to your PNG file

st.set_page_config(page_title="Alchemist", layout="wide", page_icon=icon_path)
...
with st.sidebar:
    selected = option_menu("Alchemist - Disease Prediction", 
                ['Diabetes Prediction',
